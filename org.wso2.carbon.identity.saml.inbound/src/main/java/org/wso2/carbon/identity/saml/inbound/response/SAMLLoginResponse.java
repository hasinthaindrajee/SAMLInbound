...
public class SAMLLoginResponse extends SAMLResponse {
    ...
    public static class SAMLLoginResponseBuilder extends SAMLResponseBuilder {
        ...
        public String buildResponse() throws IdentityException {
            SAMLMessageContext messageContext = (SAMLMessageContext) this.context.getParameter(SAMLSSOConstants.SAMLContext);
...
//            }
            ...
            this.setAcsUrl(messageContext.getAssertionConsumerURL());
            this.setRelayState(messageContext.getRelayState());
            return respString;
        }
